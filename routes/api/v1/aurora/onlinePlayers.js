...
{
    var onlinePlayers = await emc.Aurora.getOnlinePlayers(true).then(players => { return players }).catch(() => {})
...
{
    var onlinePlayer = await emc.Aurora.getOnlinePlayer(req.params.onlinePlayer).then(player => { return player }).catch(() => {})
